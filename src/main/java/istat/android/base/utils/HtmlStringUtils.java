...
public class HtmlStringUtils {
    ...
    static final HashMap<String, Character> decodingMap = new HashMap<>();

    public static String decode(String source) {
        if (decodingMap.isEmpty()) {
    ...
    private static String decode(String source, HashMap<String, Character> decodingTable) {
